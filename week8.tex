...
\psd{week8-crop}{16}{17}{0.96}{The \texttt{string} and \texttt{wstring} classes}{The \texttt{pair} template}{\cht{string}\cht{wstring}\cht{pair template}}
...
\psd{week8-crop}{30}{31}{0.96}{Unbalanced trees}{Tree data structures in the C++ standard}{\cht{set}\cht{multiset}\cht{map}\cht{multimap}}
...
\psd{week8-crop}{52}{53}{0.96}{The \texttt{valarray} template}{Sequence adapters: \texttt{queue} and \texttt{stack}}{\cht{valarray}\cht{queue}\cht{stack}}
\psd{week8-crop}{54}{55}{0.96}{\texttt{list}-specific functions}{The \texttt{map} class}{\cht{list}\cht{map}}
...
\psd{week8-crop}{60}{61}{0.96}{The generic algorithms}{Example: \texttt{find}}{\cht{find}}
\psd{week8-crop}{62}{63}{0.96}{Example: \texttt{find_if}}{Member functions as predicates}{\cht{find_if}}
\psd{week8-crop}{64}{65}{0.96}{\texttt{push_back} and \texttt{back_inserter}}{Penna Population}{\cht{push_back}\cht{back_inserter}}
