...
public:
    ...
    void new_shot(double x, double y)
    {
        ++total_shots_;
...
int main()
{
...
#else
    const unsigned random_seed=static_cast<unsigned>(std::time(NULL));
#endif
    ...
    unsigned checkpoints=128;
    unsigned const max_shots=128*1024*1024;
